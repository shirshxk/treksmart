...
<head>
    ...
    <title>About Us - TrekSmart</title>
        ...
        <section class="stats-section">
            <div class="container">
                <div class="stats-grid">
                    <div class="stat-item">
                        <h3 class="stat-indi">10,000+</h3>
                        <p>Trekkers' Served</p>
                    </div>
                    <div class="stat-item">
                        <h3 class="stat-indi">100%</h3>
                        <p>Client Satisfaction</p>
                    </div>
                    <div class="stat-item">
                        <h3 class="stat-indi">6+</h3>
                        <p>Years of Innovation in Trekking Tech</p>
                    </div>
                    <div class="stat-item">
                        <h3 class="stat-indi">5,000+</h3>
                        <p>Positive Reviews from Adventurers</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="founder-grid">
                    <div class="founder-content">
                        <i>
                            "TrekSmart is not just a platform; it’s a movement that redefines trekking with
                            <span class="highlight">safety</span>,
                            <span class="highlight">sustainability</span>, and
                            <span class="highlight">innovation</span>
                            at its core. Our journey has been shaped by relentless dedication,
                            local partnerships, and a deep respect for nature. We continue to evolve, ensuring every trekker
                            experiences Nepal’s beauty with <span class="highlight">confidence</span>, and <span class="highlight">ease</span>."
                        </i>
                        <h3>Shirshak Shrestha</h3>
                        <p class="subtitle">Founder/CEO - Trek<b>Smart</b></p>
                    </div>
                    <div class="founder-image">
                        <img src="/TrekSmart/assets/image/founderr.jpg" alt="Founder Image">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="team-container">
                ...
                <div class="team-grid">
                    <div class="team-member">
                        <img src="/TrekSmart/assets/image/member1.jpg" alt="Deewa Dhakal">
                        <h3>Deewa Dhakal</h3>
                        <p class="highlight-about">Co-Founder/COO</p>
                    </div>
                    <div class="team-member">
                        <img src="/TrekSmart/assets/image/membertwoo.jpg" alt="Subhrajit">
                        <h3>Subhrajit Dutta</h3>
                        <p class="highlight-about">Marketing Lead</p>
                    </div>
                    <div class="team-member">
                        <img src="/TrekSmart/assets/image/member3.jpg" alt="Saurav">
                        <h3>Saurav Satyal</h3>
                        <p class="highlight-about">HR Manager</p>
                    </div>
                    <div class="team-member">
                        <img src="/TrekSmart/assets/image/member4.jpg" alt="NIRAJ">
                        <h3>Niraj Neupane</h3>
