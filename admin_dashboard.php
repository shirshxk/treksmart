                    ...
                    <tbody>
                        <?php foreach ($packages as $index => $package): ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn-edit"
                                        onclick="openEditPackageModal(<?= $package['id'] ?>, '<?= htmlspecialchars($package['title']) ?>', '<?= htmlspecialchars($package['description']) ?>', '<?= htmlspecialchars($package['price']) ?>', '<?= htmlspecialchars($package['duration']) ?>', '<?= htmlspecialchars($package['difficulty']) ?>')">Edit
                                    </button>
